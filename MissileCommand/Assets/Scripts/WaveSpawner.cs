...
public class WaveSpawner : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        v31 = Camera.main.ViewportToWorldPoint(new Vector3(0.2f, 1.2f, 0)).x;
        v32 = Camera.main.ViewportToWorldPoint(new Vector3(0.8f, 1.2f, 0)).x;
        randomX = Random.Range(v31, v32);
        yValue = Camera.main.ViewportToWorldPoint(new Vector3(0f, 1.1f, 0)).y;
